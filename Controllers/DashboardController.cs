...
namespace Personal_Expense_Tracker.Controllers
{
    public class DashboardController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            int TotalIncome = SelectedTransactions.Where(x => x.Category.Type == "Income").Sum(j => j.Amount);
            ...
            int TotalExpense = SelectedTransactions.Where(x => x.Category.Type == "Expense").Sum(j => j.Amount);
            ...
            ViewBag.DoughnutChartData = SelectedTransactions.Where(i => i.Category.Type == "Expense").GroupBy(x => x.CategoryId).Select(k => new
            {
            ...
            //Combining both to match syntax of the Spline Chart 
